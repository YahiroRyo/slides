const W_WIDTH  = 800; // ブラウザの横サイズ
const W_HEIGHT = 450;// ブラウザの縦サイズ
const W_ASPECT = W_WIDTH / W_HEIGHT;// アスペクト比
...
window.onload = ()=>{
	...
	let material = new THREE.MeshLambertMaterial({color: 0x009DFF});
